## CODE FOR: generating NMDS plots based on 16S microbial community dissimilarity matrices
...
#remove outlier
remove_outlier <- (meta_data[-c(130),])
...
taxa_mirador <- taxa %>% dplyr::select (M1_A, M1_B, M1_C, M10_A, 
                                              ...
                                              M2_C, M3_A, M3_B, M3_C, M4_A, M4_B, M4_C, M5_A, M5_B, M6_A, 
                                              M6_B, M6_C, M7_A, M7_B, M7_C, M8_A, M8_B, M8_C, M9_A, M9_B, M9_C)

taxa_mirador_t<-t(taxa_mirador)

taxa_cerroA <- taxa %>% dplyr::select(C1_A, C1_B, C10_A, C10_B, 
                                            C10_C, C11_A, C11_B, C11_C, C12_A, C12_B, C12_C, C2_A, C2_B, C2_C, C3_A, 
                                            C3_B, C3_C, C4_A, C4_B, C4_C, C5_A, C5_B, C5_C, C6_B, C6_C, C7_A, C7_B, 
...
#save NMDS plot
ggsave(filename="galapagos16S_alldepths_mirador_NMDS_oct.pdf",
...
#save plot
ggsave(filename="galapagos16S_Cerro_A_alldepths_NMDS_october.pdf",
       device="pdf",path="./images",
       plot=cerro_A_NMDS,
       width=6,
       height=5,
...
#save plot
ggsave(filename="galapagos16S_eljunco_alldepths_NMDS_oct.pdf",
       device="pdf",path="./images",
       plot=eljunco_NMDS,
       width=6,
       height=5,
